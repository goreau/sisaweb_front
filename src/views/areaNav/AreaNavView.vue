        ...
        <div class="card">
          ...
          <div class="card-content">
            ...
            <div class="field">
              ...
              <div class="control">
                <input class="input" type="text" placeholder="Nome da Área" v-model="areaNav.descricao"
            ...
            <div class="field">
              ...
              <div class="control">
                <input class="input" type="text" placeholder="Apenas para NAV" v-model="areaNav.area"
            ...
            <div class="field">
              ...
              <div class="control">
                <input class="input" type="text" placeholder="Apenas para NAV" v-model="areaNav.percurso"
          ...
          <footer class="card-footer">
            <footerCard @submit="create" :ready="readyToGo" @cancel="null" @aux="details" :cFooter="cFooter" />
          </footer>
        </div>
      </div>
    </div>
...
function create() {
  v$.value.$touch()
  if (!v$.value.$invalid) {
    areaNavService.create(areaNav).then(
      () => {
