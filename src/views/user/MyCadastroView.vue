          ...
          <div class="card-content">
            <div class="content">
              ...
              <div class="field">
                ...
                <div class="control">
                  <input class="input" type="text" placeholder="Local do usuário" v-model="local" readonly />
                </div>
              </div>
              <div class="field">
              ...
              <div class="field">
                ...
                <div class="control">
                  <input class="input" type="text" placeholder="Nome de usuário" v-model="login" readonly />
                </div>
              </div>
              <div class="field">
                <label class="label">Senha Atual</label>
                <div class="control">
                  <input class="input" type="password" v-model="old_password" placeholder="Informe a senha"
              ...
              <div class="field">
                ...
                <div class="control">
                  <input class="input" type="password" v-model="new_password" placeholder="Confirme a senha"
