            ...
            <div class="columns">
              <div class="column is-6 is-offset-2">
                <div class="content">
                  ...
                  <div class="control">
                    <CmbTerritorio :tipo="99" :sel="ovitrampa.id_municipio" @selTerr="ovitrampa.id_municipio = $event"
              ...
              <div class="column is-2">
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" placeholder="Número do Cadastro" v-model="ovitrampa.cadastro"
            ...
            <div class="columns">
              <div class="column is-4">
                <div class="content">
                  ...
                  <div class="control">
                    <CmbGeneric :sel="ovitrampa.id_area" :data="areas" @selGen="ovitrampa.id_area = $event"
              ...
              <div class="column is-4">
                <div class="content">
                  ...
                  <div class="control">
                    <CmbGeneric :sel="ovitrampa.id_censitario" :data="censitarios"
                      @selGen="ovitrampa.id_censitario = $event" :errclass="{ 'is-danger': v$.id_censitario.$error }" />
              ...
              <div class="column is-4">
                <div class="content">
                  ...
                  <div class="control">
                    <CmbGeneric :sel="ovitrampa.id_quarteirao" :data="quarteiraos"
                      @selGen="ovitrampa.id_quarteirao = $event" :errclass="{ 'is-danger': v$.id_quarteirao.$error }" />
            ...
            <div class="columns">
              <div class="column is-2">
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" placeholder="Bairro de instalação" v-model="ovitrampa.bairro"
              ...
              <div class="column is-5">
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" placeholder="Endereço do imóvel" v-model="ovitrampa.endereco"
              ...
              <div class="column is-5">
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" placeholder="Responsável pelo imóvel" v-model="ovitrampa.morador"
            ...
            <div class="columns">
              <div class="column is-4">
                <div class="content">
                  ...
                  <div class="control">
                    <CmbGeneric :sel="ovitrampa.motivo" :data="motivos" @selGen="ovitrampa.motivo = $event"
              ...
              <div class="column is-4">
                <div class="content">
                  ...
                  <div class="control">
                    <CmbGeneric :sel="ovitrampa.periodicidade" :data="periodicidades"
                      @selGen="ovitrampa.periodicidade = $event" :errclass="{ 'is-danger': v$.periodicidade.$error }" />
            ...
            <div class="columns">
              <div class="column is-4 is-offset-2">
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" placeholder="Opcional" v-model="ovitrampa.latitude" v-decimal
              ...
              <div class="column is-4">
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" placeholder="Opcional" v-model="ovitrampa.longitude" v-decimal
