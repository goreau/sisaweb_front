...
function loadData() {
  ...
  imovelService.getImovels(JSON.stringify(filter))
    .then((response) => {
...
onMounted(() => {
  columns.value = [
    ...
    { title: 'Tipo', field: 'tipo', minWidth: 150 },
    { title: 'Cadastro', field: 'cadastro', minWidth: 150 },
    { title: 'Nome Fantasia', field: 'fantasia', minWidth: 150 },
    { title: 'Endereço', field: 'endereco', minWidth: 150 },
    { title: 'Responsável', field: 'owner', minWidth: 100 },
    {
      ...
      formatter: (cell) => {
        ...
        btDel.addEventListener('click', async () => {
          ...
          if (ok) {
            const resultado = await imovelService.delete(row.id);
            if (resultado.error) {
